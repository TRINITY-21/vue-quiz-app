...
<div class="ctr">
  <transition name="fade" mode="out-in">
   ...
   :questionsAnswered="questionsAnswered" @questionAnswered="questionAnswered"/>
   <Results v-else :results="results" :totalCorrect="totalCorrect"/>
  
  </transition>

    <button v-if="questionsAnswered === questions.length" type="button" @click.prevent="resetChange" class="reset-btn">Reset</button>
</div>
</template>
